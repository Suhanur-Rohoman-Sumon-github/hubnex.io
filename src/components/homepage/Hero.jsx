    ...
    <div className=' h-full w-full'>
      <div className=' flex h-full w-[80%] md:w-[75%] flex-col lg:gap-2 lg:mt-36 xl:mt-56 md:justify-center lg:justify-start items-start m-auto text-white'>
        ...
        <div className=' flex flex-col gap-5 sm:gap-2'>
          ...
          <Link to='/contact' className=' w-max border-white font-gilroy-semi-bold text-[16px] md:text-[20px] border-2 md:border-none bg-transparentmd:border-none md:bg-white text-white md:text-black rounded-full py-2 lg:py-[10px] px-5'>Get started</Link>
        </div>
      </div>
    </div>
  )
